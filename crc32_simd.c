    ...
    uint32_t crc)
{
    ...
    x2 = _mm512_loadu_si512((__m512i*)(buf + 0x10));
    x3 = _mm512_loadu_si512((__m512i*)(buf + 0x20));
    x4 = _mm512_loadu_si512((__m512i*)(buf + 0x30));
    ...
    while (len >= 64)
    {
        ...
        y6 = _mm512_loadu_si512((__m512i*)(buf + 0x10));
        y7 = _mm512_loadu_si512((__m512i*)(buf + 0x20));
        y8 = _mm512_loadu_si512((__m512i*)(buf + 0x30));
     ...
     */
    x2 = _mm512_clmulepi64_epi128(x1, x0, 0x10);
    x3 = _mm512_setr4_epi32(~0, 0, ~0, 0);
    x1 = _mm512_srli_epi32(x1, 8);
    x1 = _mm512_xor_si512(x1, x2);

    x0 = _mm512_load_epi64((__m512i*)k5k0);

    x1 = _mm512_srli_epi32(x1, 4);
    x1 = _mm512_and_si512(x1, x3);
    x1 = _mm512_clmulepi64_epi128(x1, x0, 0x00);
    x1 = _mm512_xor_si512(x1, x2);

    /*
     * Barret reduce to 32-bits.
     */
    x0 = _mm512_load_si512((__m512i*)poly);

    x2 = _mm512_and_si512(x1, x3);
    x2 = _mm512_clmulepi64_epi128(x2, x0, 0x10);
    x2 = _mm512_and_si512(x2, x3);
    x2 = _mm512_clmulepi64_epi128(x2, x0, 0x00);
    x1 = _mm512_xor_si512(x1, x2);

    /*
     * Return the crc32.
     */
    return _mm256_extract_epi32(_mm512_castsi512_si256(x1), 1);
}
